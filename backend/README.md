...
## Project Structure
    ...
    ├── testapiautosettings_76010  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_76010`
...
2. Clone this repo and `cd testapiautosettings_76010`
